 ...
 * "ราคางานจัดซ่อมสะพานคนเดินข้ามถนน ประมาณก.pdf" (แผ่นที่ 1-2)
 *
...
(function (root) {
  const catalog = [
    { id: 'pdf-1.1.1', code: '1.1.1', name: 'เคลือบทับหน้ากันลื่นพื้นสะพานและบันไดด้วยวัสดุ Polyurethane', unit: 'ตร.ม.', rate: 600, condition: 'all', auto: 'puTotal' },
    { id: 'pdf-1.1.2', code: '1.1.2', name: 'งานซ่อมรอยแตกร้าวคอนกรีตโครงสร้างด้วย High Strength Mortar', unit: 'ตร.ม.', rate: 4300, condition: 'concrete', auto: null },
    { id: 'pdf-1.1.3', code: '1.1.3', name: 'ฉาบพื้นผิวสะพานด้วย High Strength Mortar', unit: 'ตร.ม.', rate: 1300, condition: 'concrete', auto: 'mortar' },
    { id: 'pdf-1.1.4', code: '1.1.4', name: 'ทาสีสะพานส่วนที่เป็นคอนกรีต', unit: 'ตร.ม.', rate: 100, condition: 'concrete', auto: null },
    { id: 'pdf-1.1.5', code: '1.1.5', name: 'ตีเส้นแบ่งช่องทางเดินบนสะพานและบันได', unit: 'ตร.ม.', rate: 120, condition: 'all', auto: 'marking' },
    { id: 'pdf-1.1.6.1', code: '1.1.6.1', name: 'ปรับปรุงซ่อมแซมท่อน้ำทิ้ง PVC ขนาด 4 นิ้ว', unit: 'ม.', rate: 300, condition: 'all', auto: null },
